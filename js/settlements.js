...
(function () {
  ...
  function attachCheckboxListeners() {
    document.querySelectorAll('#settlements-tbody .row-checkbox').forEach((cb) => {
  ...
  function updateSelectAllState() {
    ...
    if (!selectAll) return;
    const checkboxes = document.querySelectorAll('#settlements-tbody .row-checkbox');
    const total = checkboxes.length;
    const checked = document.querySelectorAll('#settlements-tbody .row-checkbox:checked').length;
  ...
  function saveBulkEdit() {
    ...
    selectedIds.forEach((id) => {
      Data.saveSettlement(Object.assign({ id: id }, patch));
    });
    selectedIds.clear();
    closeModal();
    renderSettlements();
