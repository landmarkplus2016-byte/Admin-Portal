...
(function () {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      'common.bulkEdit': 'Bulk Edit',
      'common.clearSelection': 'Clear',
      'common.bulkEditTitle': 'Bulk Edit {count} Records',
      'common.bulkEditHint': 'Only the fields you set below will be applied to all selected records. Leave a field unset to keep it unchanged.',
      'common.noFieldsChanged': 'Pick at least one field to update.',
      'common.bulkUpdated': '{count} records updated',
    ...
    ar: {
      ...
      'common.bulkEdit': 'تعديل جماعي',
      'common.clearSelection': 'إلغاء التحديد',
      'common.bulkEditTitle': 'تعديل جماعي لـ {count} سجل',
      'common.bulkEditHint': 'سيتم تطبيق الحقول التي تحددها أدناه فقط على جميع السجلات المحددة. اترك الحقل بدون تغيير للاحتفاظ بقيمته الحالية.',
      'common.noFieldsChanged': 'اختر حقلاً واحداً على الأقل للتحديث.',
      'common.bulkUpdated': 'تم تحديث {count} سجل',
